    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-blue-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">Nationwide Lending Coverage</h1>
          <p className="text-xl text-center mb-8">Providing real estate financing solutions across 41 states</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-8 text-center">Our Lending Coverage</h2>
            <div className="mb-12">
              <USMap availableStates={AVAILABLE_STATES} />
            </div>
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Join thousands of satisfied investors who trust Elevate Funding for their real estate financing needs.</p>
